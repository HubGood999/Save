...
while true do
    ...
    if AppleAmount >= 60 then  -- ถ้าจำนวนหินครบ 60 หรือมากกว่า
        ...
        -- ย้ายผู้เล่นไปที่ตำแหน่งที่ต้องการ
        humanoidRootPart.CFrame = CFrame.new(2379, 37, 3164)
        wait(0.5)
        local character = player.Character or player.CharacterAdded:Wait()
        local humanoidRootPart = character:WaitForChild("HumanoidRootPart")
...
-- สร้าง loop เพื่อให้ทำงานทุก 10 วินาที
while true do
    local OrangeAmount = player.Inventory:FindFirstChild("Orange").Value  -- ตรวจสอบจำนวนหิน

    if OrangeAmount >= 60 then  -- ถ้าจำนวนหินครบ 60 หรือมากกว่า
        local character = player.Character or player.CharacterAdded:Wait()
        local humanoidRootPart = character:WaitForChild("HumanoidRootPart")
